                                                ...
                                                <td>
                                                    <ul class="nav nav-pills nav-justified" role="tablist">
                                                       <li class="nav-item waves-effect waves-light">
                                                           <a type="button" class="btn btn-info btn-sm waves-effect waves-light" href="ControladorVehiculoa?accion=entro&id=<% out.print(data5.getString(1));%>"><i class="fas fa-backward"></i></a>
                                                           <a type="button" class="btn btn-danger btn-sm waves-effect waves-light" href="ControladorVehiculoa?accion=salio&id=<% out.print(data5.getString(8));%>"><i class="fas fa-lock-open"></i></a>
                                                           <button class="btn btn-danger btn-sm waves-effect waves-light" type="button"><a href="ControladorVehiculoa?accion=eliminar&id=<% out.print(data5.getString(1));%>"><i class="fas fa-times-circle"></i></a></button>
                                                       </li>
                                                   </ul>
                                                </td>
                                            </tr>
                        ...
                        <div class="col-xl-4">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    ...
                                    <img src="Admi_Assets/images/small/img-12.jpg" class="img-fluid" alt="Responsive image" height="64"><br>
                                    <div class="pricing-features mt-4">
                                            <p class="m-b-0">Un buen administrador debe comprender y conocer el funcionamiento del conjunto desde sus aspectos legales, 
                                            económicos y estratégicos, debe planificar en base a los objetivos planteados, analizando los conflictos 
                                            y las normativas actualizadas, 
                                            acordes a la ley vigente, que rigen a la actividad que desarrolla la organización</p>
