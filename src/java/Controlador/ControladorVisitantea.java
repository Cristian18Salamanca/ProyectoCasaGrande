 ...
 * @author crist
 */
@WebServlet(name = "ControladorVisitantea", urlPatterns = {"/ControladorVisitantea"})
public class ControladorVisitantea extends HttpServlet {

    String listar="AVisitantes.jsp";
    String add="AVisitantess.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorVisitantea</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorVisitantea at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
