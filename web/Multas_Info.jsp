                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="Vehiculo_Info.jsp" class="waves-effect">
                                <i class="fas fa-car-crash"></i><span>Información Vehículos</span>
                            </a>
                        </li>
                                                 ...
                                                 <td>
                                                     <ul class="nav nav-pills nav-justified" role="tablist">
                                                        <li class="nav-item waves-effect waves-light">
                                                            <a class="btn btn-primary btn-sm waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-center" href="ControladorMulta?accion=editar&id=<% out.print(data5.getString(1));%>"><i class="fas fa-edit"></i></a>
                                                            <a type="button" class="btn btn-success btn-sm waves-effect waves-light" href="ControladorMulta?accion=cancelar&id=<% out.print(data5.getString(1));%>"><i class="fas fa-check-circle"></i></a>
                                                            <a type="button" class="btn btn-danger btn-sm waves-effect waves-light" href="ControladorMulta?accion=eliminar&id=<% out.print(data5.getString(1));%>"><i class="fas fa-times-circle"></i></a>
                                                        </li>
                                                    </ul>
                                                 </td>
                                            </tr> 
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="" action="ControladorMulta">
                                                                <div class="form-group">
                                                                    <label>Placa:</label>
