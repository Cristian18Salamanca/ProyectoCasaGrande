                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Casa Grande - Datos Inhabilitados de los Vehículos</h4><br>        
                                        ...
                                        <% 
                                            ...
                                            String qry2="SELECT `Id_Vehiculo`, `Placa`, `apartamento`, `Dueño`, `Marca`, `Color`, `Parqueadero`, `estado` FROM `vehiculos_inhabilitados` WHERE 1";
                                        ...
                                        %>
                                            ...
                                            <tr>
                                                ...
                                                <td><% out.print(data2.getString(8));%></td>
                                                <td>
                                                    <a type="button" class="btn btn-success btn-sm waves-effect waves-light" href="ControladorVehiculoInha?accion=eliminar&id=<% out.print(data2.getString(1));%>">Recuperar</a>
                                                </td>
                                            </tr><% } %>
                                            </tbody>
                                        </table>
                         ...
                         <div class="row">
                            <div class="col-lg-4">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <div class="">
                                            <img src="Admi_Assets/images/small/img-14.jpg" class="img-fluid" alt="Responsive image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">CASA GRANDE - Quejas y Reclamos Ocultos</h4><br><br>
                                        ...
                                        <% 
                                            ...
                                            String qry3="SELECT `id_queja`, `clasificacion`, `correo`, `argumento` FROM `quejas_ocultas` WHERE 1";
                                        ...
                                        %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm waves-effect waves-light"><a href="ControladorQuejasOcu?accion=eliminar&id=<% out.print(data3.getString(1));%>"><i class="far fa-eye"></i></a></button>
                                                </td>
                                            </tr>
                                            </tbody><% } %>
                                        </table>                                              
