                                         ...
                                         while(iter.hasNext()){
                                          pin=iter.next();
                                            ...
                                            <tr>
                                                ...
                                                <td><%= pin.getTel()%></td>
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm waves-effect waves-light"><a href="ControladorPersonaInha?accion=eliminar&id=<%= pin.getId()%>">Recuperar</a></button>
                                                </td>
                                            </tr>
                                            <%}%>
                                            </tbody>
